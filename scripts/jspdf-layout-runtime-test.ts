...
async function testLayoutDocumentKeepsOrderedListNumberAcrossSurroundPageBreak() {
  const previousDocument = globalThis.document
  const runtimeGlobal = globalThis as any
        ...
        result: {
          data: {
            ...
            main: [
              {
                type: ElementType.IMAGE,
                value: 'data:image/png;base64,surround-ordered-list-page-break',
                width: 60,
                height: 24,
                imgDisplay: ImageDisplay.SURROUND,
                imgFloatPosition: {
...
async function testLayoutDocumentContinuesOrderedListNumberingAcrossSurroundPageBreak() {
  const previousDocument = globalThis.document
  const runtimeGlobal = globalThis as any
        ...
        result: {
          data: {
            ...
            main: [
              {
                type: ElementType.IMAGE,
                value: 'data:image/png;base64,surround-ordered-list-multi-item',
                width: 60,
                height: 24,
                imgDisplay: ImageDisplay.SURROUND,
                imgFloatPosition: {
...
async function testLayoutDocumentKeepsLineNumbersAcrossSurroundPageBreak() {
  const previousDocument = globalThis.document
  const runtimeGlobal = globalThis as any
  ...
  try {
        ...
        result: {
          data: {
            ...
            main: [
              ...
              {
                type: ElementType.IMAGE,
                value: 'data:image/png;base64,line-number-surround-page-break',
                width: 60,
                height: 24,
                imgDisplay: ImageDisplay.SURROUND,
                imgFloatPosition: {
    ...
    assert.deepEqual(
      pageList.map(page =>
        page.textRuns
          .filter(run => run.text === '1' || run.text === '2')
...
async function testLayoutDocumentKeepsMixedArtifactsAcrossThreePagesWithMultiSurround() {
  const previousDocument = globalThis.document
  const runtimeGlobal = globalThis as any
  ...
  try {
            ...
            main: [
              {
                ...
                valueList: [
                  ...
                  {
                    type: ElementType.IMAGE,
                    value: 'data:image/png;base64,multi-surround-1',
                    width: 60,
                    height: 24,
                    imgDisplay: ImageDisplay.SURROUND,
                    imgFloatPosition: {
                  ...
                  {
                    type: ElementType.IMAGE,
                    value: 'data:image/png;base64,multi-surround-2',
                    width: 50,
                    height: 24,
                    imgDisplay: ImageDisplay.SURROUND,
                    imgFloatPosition: {
                  ...
                  },
                  {
                    type: ElementType.HYPERLINK,
                    value: '',
                    url: 'https://example.com/multi-surround',
                    valueList: [
                      {
                        value: 'hhhhhhhh'
                      }
    ...
    assert.deepEqual(
      pageList.map(page => page.links.map(link => link.url)),
      [[], ['https://example.com/multi-surround'], []]
    )
    assert.deepEqual(
      pageList.map(page =>
        page.vectorLines.filter(line => line.color === '#cc8800').length
...
async function testLayoutDocumentKeepsTableAndControlAcrossSurroundPageBreak() {
  const previousDocument = globalThis.document
  const runtimeGlobal = globalThis as any
  ...
  runtimeGlobal.document = {
    createElement(tagName: string) {
      ...
      return {
        toDataURL() {
          return 'data:image/png;base64,table-surround-area-fallback'
        },
        getContext() {
          return {
            font: '',
            ...
            main: [
              {
                ...
                valueList: [
                  ...
                  {
                    type: ElementType.IMAGE,
                    value: 'data:image/png;base64,table-surround-area-image',
                    width: 60,
                    height: 24,
                    imgDisplay: ImageDisplay.SURROUND,
                    imgFloatPosition: {
...
async function testLayoutDocumentKeepsRowspanTableAcrossSurroundPageBreak() {
  const previousDocument = globalThis.document
  const runtimeGlobal = globalThis as any
  ...
  runtimeGlobal.document = {
    createElement(tagName: string) {
      ...
      return {
        toDataURL() {
          return 'data:image/png;base64,rowspan-table-surround-fallback'
        },
        getContext() {
          return {
            font: '',
            ...
            main: [
              {
                ...
                valueList: [
                  ...
                  {
                    type: ElementType.IMAGE,
                    value: 'data:image/png;base64,rowspan-surround-image',
                    width: 60,
                    height: 24,
                    imgDisplay: ImageDisplay.SURROUND,
                    imgFloatPosition: {
                  ...
                  },
                  {
                    ...
                    trList: [
                      {
                        height: 24,
                        tdList: [createTd('A1', 1, 2), createTd('B1')]
                      },
                      {
                        height: 24,
                        tdList: [createTd('B2')]
...
async function testLayoutDocumentKeepsCompoundSpanTableAcrossSurroundPageBreak() {
  const previousDocument = globalThis.document
  const runtimeGlobal = globalThis as any
  ...
  runtimeGlobal.document = {
    createElement(tagName: string) {
      ...
      return {
        toDataURL() {
          return 'data:image/png;base64,compound-table-surround-fallback'
        },
        getContext() {
          return {
            font: '',
            ...
            main: [
              {
                ...
                valueList: [
                  ...
                  {
                    type: ElementType.IMAGE,
                    value: 'data:image/png;base64,compound-table-surround-image',
                    width: 60,
                    height: 24,
                    imgDisplay: ImageDisplay.SURROUND,
                    imgFloatPosition: {
                  ...
                  },
                  {
                    type: ElementType.TABLE,
                    value: '',
                    colgroup: [{ width: 24 }, { width: 28 }, { width: 28 }],
                    trList: [
                      {
                        height: 24,
                      ...
                      {
                        height: 24,
                        tdList: [createTd('D'), createTd('E'), createTd('F')]
                      }
                    ]
                  },
                  {
...
async function run() {
  ...
  await testLayoutDocumentKeepsOrderedListNumberAcrossSurroundPageBreak()
  await testLayoutDocumentContinuesOrderedListNumberingAcrossSurroundPageBreak()
